"""
Django settings for falling_leaf_dev_133934 project.
...
ROOT_URLCONF = 'falling_leaf_dev_133934.urls'
...
WSGI_APPLICATION = 'falling_leaf_dev_133934.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_leaf_dev_133934 API",
    "DESCRIPTION": "API documentation for falling_leaf_dev_133934 App",
    "VERSION": "v1",
}
